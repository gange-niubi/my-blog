...
export const siteConfig: SiteConfig = {
	...
	featurePages: {
		anime: true,
		diary: true,
		friends: false, // 友链已从导航移除，需要时可在 navbar 中加回并设为 true
	...
	favicon: [
		{ src: "/favicon/favicon.png", theme: "light", sizes: "64x64" },
		{ src: "/favicon/favicon.png", theme: "dark", sizes: "64x64" },
	],
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://api.qijieya.cn/meting/?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址（原 meting.mysqil.com 易超时，已换为可用源）
	id: "14164869977", // 歌单ID
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		link: "https://jingjingya.xyz/", // 关于链接
	},
};
